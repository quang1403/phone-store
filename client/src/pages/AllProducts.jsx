...
const AllProducts = () => {
  ...
  // Fetch products trực tiếp khi URL thay đổi (như trang chi tiết sản phẩm)
  useEffect(() => {
    // Khi filters hoặc trang thay đổi, build query string và gọi API search
    const params = {};
    ...
    console.log("[FE] Params gửi lên API:", params);
  ...
  const fetchProducts = async (params) => {
    try {
      ...
      console.log("[FE] Dữ liệu trả về từ API:", response?.data);
